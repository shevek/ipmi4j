...
public enum SensorType implements Code.DescriptiveWrapper {
    ...
    Cable_or_Interconnect(0x1B, "Cable / Interconnect"),
    Terminator(0x1C, "Terminator"),
    System_Boot_or_Restart_Initiated(0x1D, "System Boot / Restart Initiated"),
    Boot_Error(0x1E, "Boot Error"),
    Base_OS_Boot_or_Installation_Status(0x1F, "Base OS Boot / Installation Status"),
